...
get_ipython().run_cell_magic('sql', '', 'SELECT COUNT(DISTINCT country_name) AS total_distinct_countries FROM international_debt;')
...
get_ipython().run_cell_magic('sql', '', 'SELECT indicator_code  \n    AS debt_indicator,indicator_name,\n    AVG(debt) AS average_debt\nFROM international_debt\nGROUP BY debt_indicator,indicator_name\nORDER BY average_debt\nDESC\nLIMIT 10;')
...
get_ipython().run_cell_magic('sql', '', 'select indicator_code,\ncount(indicator_code) as indicator_count from  international_debt\ngroup by indicator_code\norder by indicator_count DESC,indicator_code\nDESC\nlimit 20')
...
get_ipython().run_cell_magic('sql', '', 'SELECT country_name,\nMAX(debt) as maximum_debt from international_debt\ngroup by country_name\norder by maximum_debt\ndesc\nlimit 10')
